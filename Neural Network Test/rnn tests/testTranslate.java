...
public class testTranslation extends CSVReadWrite {
...
//	int largest_number = (int) Math.pow(2, binary_dim);
	double alpha = 0.1;
	String comp = "EA";
	ArrayList<double[]> data = readCsv("C:\\Users\\Tim Huang\\Documents\\GitHub\\highlighter\\Neural Network Test\\Data\\"+ comp + "DataAdjst.csv");
