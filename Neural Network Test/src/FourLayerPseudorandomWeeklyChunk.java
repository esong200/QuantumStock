...
public class FourLayerPseudorandomWeeklyChunk {
	public static void main(String[] args) {
		...
		String weights0Directory = "/Users/ethansong/Documents/GitHub/highlighter/Neural Network Test/UltraBigWeeklyChunk/Matrixes/FourLayer/Weights0/" + comp + runName + "synapticWeights0.csv";
		String weights1Directory = "/Users/ethansong/Documents/GitHub/highlighter/Neural Network Test/UltraBigWeeklyChunk/Matrixes/FourLayer/Weights1/" + comp + runName + "synapticWeights1.csv";
		String weights2Directory = "/Users/ethansong/Documents/GitHub/highlighter/Neural Network Test/UltraBigWeeklyChunk/Matrixes/FourLayer/Weights2/" + comp + runName + "synapticWeights2.csv";
		String weights3Directory = "/Users/ethansong/Documents/GitHub/highlighter/Neural Network Test/UltraBigWeeklyChunk/Matrixes/FourLayer/Weights3/" + comp + runName + "synapticWeights3.csv";
		...
		double[][] intermediateAnswer2 = new double[4][desiredOutcome.length];
		double[] synapticWeights3 = new double[4];
		double[]finalAnsArr = new double[desiredOutcome.length];
		
		double[] error3 = new double[desiredOutcome.length];
		double[] delta3 = new double[desiredOutcome.length];
		...
		try {
			...
			synapticWeights3 = CSVReadWrite.readCsv(weights3Directory).get(0);
