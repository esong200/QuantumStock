...
public class AlphaVantageCollector extends CSVReadWrite{
	...
	public static double[] DataAdd (String symbol){
		/*returns data in form Open High Low close volume sma50 ema50 sma100 ema100 macdHist macdSig
		 * macd stochd stochk rsi50 rsi100 adx50 aroon50down aroon50up aroon100down aroon100up
		 * bband50Low bband50Mid bband50Hi bband100Low bband100Mid bband100Hi ad obv
		 */
		...
		returnArrayList.remove(0);
	//returnArrayList.remove(0);
		double[] dataLine = returnArrayList.get(0);
	...
	/*		while(Math.pow(2, size)<= nonBin) {
			...
			//System.out.println("Input: " + nonBin);
			if(nonBin>0) {
	...
	public static ArrayList<double[]> answerCompileWeeklyExact (String symbol){
		ArrayList<double[]> monthly = weeklyData(symbol);
		ArrayList<double[]> answers = new ArrayList<double[]>();
		for(int i = 0; i < monthly.size() -1; i++){
	...
	public static ArrayList<double[]> DataCollectionWeekly (String symbol){
		/*returns data in form Open High Low close volume sma50 ema50 sma100 ema100 macdHist macdSig
		* macd stochd stochk rsi50 rsi100 adx50 aroon50down aroon50up aroon100down aroon100up
		* bband50Low bband50Mid bband50Hi bband100Low bband100Mid bband100Hi ad obv
		*/
	...
	SMA smaTest = technicalIndicators.sma(symbol, Interval.WEEKLY, TimePeriod.of(100), SeriesType.OPEN);
		System.out.println("Internet Works");
	try {
		System.out.println("sleeping");
		Thread.sleep(60000);
	...
	EMA emaTest = technicalIndicators1.ema(symbol, Interval.WEEKLY, TimePeriod.of(100), SeriesType.OPEN);
	...
	RSI rsi100 = technicalIndicators1.rsi(symbol, Interval.WEEKLY, TimePeriod.of(100), SeriesType.OPEN);
	try {
			System.out.println("sleeping");
		Thread.sleep(60000);
	...
	//ADX adx100 = technicalIndicators2.adx(symbol, Interval.WEEKLY, TimePeriod.of(100));
	...
	AROON aroon100 = technicalIndicators2.aroon(symbol, Interval.WEEKLY, TimePeriod.of(100));
	...
	BBANDS bbands100 = technicalIndicators2.bbands(symbol, Interval.WEEKLY, TimePeriod.of(100), SeriesType.OPEN, null, null, null);
	...
	public static double[] DataWeeklyAdd (String symbol){
		/*returns data in form Open High Low close volume sma50 ema50 sma100 ema100 macdHist macdSig
		 * macd stochd stochk rsi50 rsi100 adx50 aroon50down aroon50up aroon100down aroon100up
		 * bband50Low bband50Mid bband50Hi bband100Low bband100Mid bband100Hi ad obv
		 */
	...
	public static double[] addWeeklyAns (String symbol) {
		ArrayList<double[]> monthly = weeklyData(symbol);
		double[] answers = new double[8];
		//for(int i = 0; i < monthly.size() -1; i++){
