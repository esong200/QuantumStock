...
public class StockRunner {
	public static void main(String[] args) {
		String[] comps = //{"FTI", "HAS", "INT", "IVZ", "MSFT", "NVDA","PEP", "T"};
						   {	"FTI"};
		for(String comp : comps) {
			try {
				...
				String outcomesDirectory = "/Users/ethansong/Documents/GitHub/highlighter/Neural Network Test/Outcomes/" + comp + "Outcomes.csv";
				...
				System.out.println(comp + "Stock Data failed. Moving on to the next one.");
			}
